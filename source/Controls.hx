...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		// Q - Left | S - Down | Z - Up | D - Right

		// trace("Current keybinds : " + leftkeybind, downkeybind, upkeybind, rightkeybind);

		#if (haxe >= "4.0.0")
		switch(keyboardScheme)
		{
			case Solo:
				inline bindKeys(Control.UP, [upkeybind, FlxKey.UP]);
		...
		{
			case Solo:
				bindKeys(Control.UP, [upkeybind, FlxKey.UP]);
			...
			case Duo(true):
				...
				bindKeys(Control.LEFT, [leftkeybind]);
				bindKeys(Control.RIGHT, [rightkeybind]);
